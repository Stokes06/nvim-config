...
-- vim.keymap.set("n", "<M-j>", "<cmd>cnext<CR>zz", { noremap = true })
-- vim.keymap.set("n", "<M-k>", "<cmd>cprev<CR>zz", { noremap = true })
...
vim.keymap.set("n", "<leader>e", "<cmd>Neotree toggle<cr>", { desc = "Toggle Explorer Sidebar" })

-- TIP: Disable arrow keys in normal mode
-- vim.keymap.set('n', '<left>', '<cmd>echo "Use h to move!!"<CR>')
-- vim.keymap.set('n', '<right>', '<cmd>echo "Use l to move!!"<CR>')
-- vim.keymap.set('n', '<up>', '<cmd>echo "Use k to move!!"<CR>')initinit
